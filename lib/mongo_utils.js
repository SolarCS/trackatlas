...
let collctionMixin = {
    ...
    async getById(object_id, projection = {}) {
        return await this.collection.find({_id: ObjectId(object_id)}).project(projection).toArray();
    }
}
...
class CareProviders {
    constructor(connection) {
        ...
        this.collectionName = 'care_providers';
...
Object.assign(CareProviders.prototype, collctionMixin);
...
exports.OutreachProgram = OutreachProgram;
